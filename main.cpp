...
{
    Keypad.Mouse_X = xpos/2.75;
    Keypad.Mouse_Y = ypos/2.75;
}
...
int main(int argc, char** argv)
{
    ...
    GLFWwindow* W;
    W = glfwCreateWindow(640*MAGNIFICATION,360*MAGNIFICATION, "Cruiser Submarine Sonichu", NULL, NULL); //SCREEN SIZE
    ...
    Write_TwoD_Sprite_Animation("explosion.and");
